...
function requestListener(req, res) {
  ...
  if (req.url === "/") {
    ...
    const body = [];
    req.on('data', chunk => {
      console.log('Here We Have Our Chunk', chunk);
      body.push(chunk)
    })
    req.on('end', () => {
      const fullBody = Buffer.concat(body).toString();
      console.log('Here We Have Full Body', fullBody);
      ...
      console.log('Here We Got Our Full Object', bodyObject);
...
//todo Here We will write just requestListener function and use it in app.js
// const fs = require('fs')
